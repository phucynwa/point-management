...
User.create! name: "Bùi Trung Hiếu",
...
User.create! name: "Nguyễn Huy Hoàng",
...
User.create! name: "Nguyễn Quang Hiển",
  email: "mcjambi@gmail.com",
  code: 3,
  role: 1,
  birthday: Faker::Date.birthday(27, 45),
  password: "123123",
...
User.create! name: "Phạm Văn Thạch",
...
ten = ["Thanh", "Quang", "Phúc", "Minh", "Hồng", "Ngọc", "Dũng", "Linh", "An", "Thành", "Anh", "Quân", "Trung", "Giang", "Hà", "Hải", "Phương", "Hằng", "Việt", "Bình", "Nam", "Quý", "Kiên", "Cường"]
...
493.times do |i|
  ...
  email = emails[i]
  p email
  code = [14, 15, 16, 17].sample * 1000000 + 20000 + Faker::Number.unique.between(0001, 9999)
...
Lecture.create! name: "Đại số", credits: 1

Lecture.create! name: "Giải tích 1", credits: 4
...
Lecture.create! name: "Mạng không dây", credits: 1

Lecture.create! name: "Đồ họa máy tính", credits: 3

Lecture.create! name: "Xử lý ngôn ngữ tự nhiên", credits: 2

Lecture.create! name: "Phát triển ứng dụng web", credits: 3

Lecture.create! name: "Xác suất thống kê", credits: 3

Lecture.create! name: "Những nguyên lý cơ bản của chủ nghĩa Mác - Lênin", credits: 3

Lecture.create! name: "Toán học rời rạc", credits: 3

Lecture.create! name: "Phát triển ứng dụng di động", credits: 2

Lecture.create! name: "Lập trình nhúng", credits: 3

90.times do
  lecture_id = Random.rand(21) + 1
  user_id = Random.rand(5) + 1
  lectt = lecture_id > 9 ? lecture_id.to_s : ("0" + lecture_id.to_s)
  name_ = "INT" + lectt + Faker::Number.unique.number(2)
...
p "50%..."
(6..500).each do |user_id|
  courses_number = Random.rand(10) + 10
